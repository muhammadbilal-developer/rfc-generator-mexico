    ...
    <section id={id} className={`${SECTION_PADDING_Y} ${bgClass}`}>
      <LayoutContainer>
        ...
        >
          ...
          <AnimatedReveal
            delay={0.08}
            className={`min-w-0 ${compactImage ? "" : "lg:sticky lg:top-[calc(var(--header-offset)+1.25rem)]"} lg:self-start`}
          >
            <ContentImage
              src={image}
              alt={imageAlt}
