...
import { SmoothTabPanels, SmoothViewToggle } from "../SmoothPanels";
          ...
          result ? (
            <div
              className={`p-5 sm:p-6 md:p-8 ${
                result.valid ? "bg-emerald-50/80" : "bg-red-50/50"
              }`}
            >
              <p
  ...
  return (
    <div className="overflow-hidden rounded-xl border-2 border-white bg-white/90 shadow-[0_16px_48px_rgba(16,185,129,0.12)] backdrop-blur-lg">
      ...
      <SmoothViewToggle
        ...
        secondary={
          result ? (
            <div className="bg-gradient-to-br from-emerald-50/80 to-white p-5 sm:p-6 md:p-8">
        ...
        <AnimatedReveal delay={0.06} className="mt-8 md:mt-10">
          <div className="mx-auto w-full max-w-5xl md:px-2 lg:px-0">
            ...
            <SmoothTabPanels
              activeId={tab}
              panels={[
                { id: "datos", content: <RfcGeneratorCard variant="consultar-rfc" /> },
                { id: "validar", content: <ValidateRfcPanel /> },
                { id: "curp", content: <CurpConsultaPanel /> },
              ]}
            />
